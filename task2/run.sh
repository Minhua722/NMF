...
AR="/Users/HU-MENGDIE/CV/final/datasets/ar_cropped_data"
...
python cnmf.py --dir_name $AR --num_basis $num_bases --num_M $num_M --num_W $num_W --out_dir $exp_dir --alg_id cnmf --num_iters 100
